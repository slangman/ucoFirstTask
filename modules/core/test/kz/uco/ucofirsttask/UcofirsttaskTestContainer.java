...
public class UcofirsttaskTestContainer extends TestContainer {

    public UcofirsttaskTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "kz/uco/ucofirsttask/app.properties",
    ...
    public static class Common extends UcofirsttaskTestContainer {

        public static final UcofirsttaskTestContainer.Common INSTANCE = new UcofirsttaskTestContainer.Common();
